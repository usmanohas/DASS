    ...
    <div className="container-fluid py-4">
      ...
      <div className="card border-0 shadow-sm rounded-4 mb-4 overflow-hidden">
        <div
          className="p-4"
          style={{
            background: "linear-gradient(135deg, #198754 0%, #149821 100%)",
          }}
        >
          ...
          <div className="d-flex align-items-center mb-3">
            <div
              ...
              style={{
                width: "45px",
                height: "45px",
                background: "rgba(146, 234, 149, 0.97)",
                color: "#198754",
              }}
            >
                  ...
                  <tbody>
                    {staff.map((s) => (
                      ...
                      >
                        ...
                        <td>
                          <span
                            className="badge rounded-pill px-3 py-2 bg-success-subtle text-success"
...
export default StaffDirectoryAdmin;
