  ...
  return (
    <div className="container-fluid py-4">
      ...
      <div className="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
        ...
        <div
          className="shadow-sm rounded-4 px-4 py-3 border bg-success text-center"
        >
                ...
                <div className="d-flex justify-content-between align-items-start gap-3">
                  <div style={{ flex: 1 }}>
                    <div className="d-flex align-items-center gap-2 mb-2">
                      ...
                      <div>
                        <h6 className="fw-bold mb-0">#{t.ticket_number}</h6>

                        <small className="text-muted">Support Request</small>
                      </div>
                    </div>

                    <h5 className="fw-semibold mb-2 mt-3">{t.subject}</h5>
                  </div>
          ...
          <div className="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
            ...
            <div className="modal-header bg-light border-0 px-4 py-3">
              <div>
                ...
                <small className="text-muted">Support ticket information</small>
              </div>
              ...
              {selectedTicket && (
                <>
                  ...
                  <div className="d-flex justify-content-between align-items-start flex-wrap gap-3 mb-4">
                    <div>
                      <h4 className="fw-bold mb-2">{selectedTicket.subject}</h4>
