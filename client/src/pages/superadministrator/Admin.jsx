...
const AdminManagement = () => {
  ...
  const resetPassword = async (id) => {
    const confirm = await Swal.fire({
      ...
      text: "Password will be reset to default (Admin@123)",
      icon: "warning",
      showCancelButton: true,
    ...
    <div className="container py-4">
      ...
      <div className="d-flex justify-content-between align-items-center mb-4">
        <div>
          ...
          <small className="text-muted">Manage system administrators</small>
        </div>
        ...
        <button
          ...
          onClick={() => {
            ...
            setForm({
              ...
              designation: "",
              division_unit_state: "",
              file_number: generateFileNumber(), // ✅ generate here
              email: "",
              phone_number: "",
              username: "",
              password: "",
                  ...
                  <div>
                    {foundUser.role === "ADMIN" ? (
                      <span className="text-danger px-3 py-2">
                       <i className="bi bi-info-circle me-2"></i>Already Admin
                      </span>
                    ) : (
                      <button
                        className="btn btn-danger btn-sm px-3"
                        onClick={() => makeAdmin(foundUser.id)}
                      >
        ...
        <div className="card-body table-responsive">
          ...
          {admins.length === 0 && (
            <div className="text-center p-5">
              ...
              <p className="text-muted">No admin found</p>
            </div>
          )}
        </div>
      </div>
            ...
            <div className="modal-dialog">
              <div className="modal-content">
                <div className="modal-header">
                  <h6 className="modal-title">Create Admin Account</h6>
                ...
                <div className="modal-footer">
                  ...
                  <button
                    className="btn btn-success"
                    onClick={isEdit ? updateAdmin : createAdmin}
                  >
