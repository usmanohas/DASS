...
/*
  ...
  */
  ...
  /* ================= MAKE FOCAL PERSON ================= */
  const makeFocalPerson = async (id) => {
    const confirm = await Swal.fire({
      title: "Make this user focal person?",
      icon: "question",
  ...
  const resetPassword = async (id) => {
    const confirm = await Swal.fire({
      ...
      text: "Password will be reset to default (FP@123)",
      icon: "warning",
      showCancelButton: true,
  ...
  const toggleStatus = async (id, currentStatus) => {
    const confirm = await Swal.fire({
      title: currentStatus ? "Deactivate Focal Person?" : "Activate Focal Person?",
      ...
      <div className="d-flex justify-content-between align-items-center mb-4">
        <div>
          <h3 className="fw-semibold mb-0">
            ...
            Focal Person Management
          </h3>
          <small className="text-muted">Manage departmental/zonal focal person</small>
        </div>
            ...
            <div className="mt-4">
              {!foundUser ? (
                ...
                <div className="border rounded p-3 d-flex justify-content-between align-items-center">
                  ...
                  {/* RIGHT */}
                  <div>
                    {foundUser.role === "FOCAL_PERSON" ? (
                      <span className="text-danger px-3 py-2">
                       <i className="bi bi-info-circle me-2"></i>Already focal person
                      </span>
                    ) : (
                      <button
                        className="btn btn-danger btn-sm px-3"
                        onClick={() => makeFocalPerson(foundUser.id)}
                      >
        ...
        <div className="card-body table-responsive">
          ...
          {admins.length === 0 && (
            <div className="text-center p-5">
              ...
              <p className="text-muted">No focal person found</p>
            </div>
          )}
        </div>
      </div>
            ...
            <div className="modal-dialog">
              <div className="modal-content">
                <div className="modal-header">
                  <h6 className="modal-title">Create Focal Person Account</h6>
                ...
                <div className="modal-footer">
                  ...
                  <button
                    className="btn btn-success"
                    onClick={isEdit ? updateFocalPerson : createFocalPerson}
                  >
...
export default FocalPersonManagement;
