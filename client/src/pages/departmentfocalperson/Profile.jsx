...
const DfpProfile = () => {
  ...
  const loadProfile = () => {
    axios
      .get("http://localhost:3000/department/user", { withCredentials: true })
      .then((res) => {
        if (res.data.Status) {
  ...
  const handleUpdate = async () => {
    ...
    try {
      const res = await axios.put(
        "http://localhost:3000/department/user/update",
        editData,
  ...
  return (
    <div className="container py-4">
      <h4 className="mb-4">
        <i className="bi-person-bounding-box me-2"></i>
        My Profile
      </h4>
        ...
        <div className="col-md-4">
          <div className="card shadow-sm border-0 text-center">
            <div className="card-body">
              ...
              <p className="mb-0">
                <small className="fw-normal">{user.division_unit_state}</small>
              </p>
              <p
                className="badge"
                style={{ backgroundColor: "#2cd2d2", color: "#fff" }}
              >
                {user.role}
              </p>
