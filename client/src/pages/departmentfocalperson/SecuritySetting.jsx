...
const SecuritySettingsDFP = () => {
  ...
  const fetchExistingSettings = async () => {
    try {
      ...
      const res = await axios.get(`${API_BASE_URL}/department/security-settings`, {
  ...
  const fetchQuestions = async () => {
    const res = await axios.get(`${API_BASE_URL}/department/security-questions`, {
      withCredentials: true,
    });
  ...
  const saveSettings = async () => {
    ...
    const res = await axios.post(
      `${API_BASE_URL}/department/security-settings`,
      { questions: form },
      { withCredentials: true },
    );
  ...
  const deleteSettings = async () => {
    ...
    const res = await axios.delete(`${API_BASE_URL}/department/security-settings`, {
      withCredentials: true,
    });
...
export default SecuritySettingsDFP;
